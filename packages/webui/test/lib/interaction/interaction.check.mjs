// webui/test/lib/interaction/interaction.check.mjs
...
//   - user-questions.js
//
// Why this test exists: the legacy test (test/lib/slash.check.mjs) only
...
// test/lib/acp-cache.check.mjs which follows the same pattern.
...
describe("tool-ask-user — ask modal state seam", () => {
  test("makeAskState returns the canonical shape", () => {
    ...
    assert.deepEqual(Object.keys(s).sort(), [
      "active", "answered", "currentIdx", "multiSelect", "options", "question", "total",
    ]);
