...
//
// What's covered here vs the existing test/lib/rate-limit.test.js:
...
//
// Baseline tests in test/lib/rate-limit.test.js already cover the happy path,
...
// Minimal req stub (matches test/lib/rate-limit.test.js shape)
