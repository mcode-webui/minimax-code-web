// webui/test/lib/state-bus-coalesce.check.mjs
...
//
// Why this file is separate from test/lib/state-bus.check.mjs: that
// file was written for the pre-coalescer sync-write contract. The C04
// tests live here so the existing file's contract remains visible at
// a glance.
