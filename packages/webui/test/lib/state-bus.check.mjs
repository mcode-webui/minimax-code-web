...
// ============================================================
// Token Plan 推送字段回归 (v2026-08-28 modacker):
//   pushStateFor / pushOnlineCount / ensureMcodeSessionsFetchedAndPush
//   三个推送点的 snapshot 都必须带 quotaEnabled / hasTokenPlanKey /
//   tokenPlanApiKeyMasked, 否则 SSE 整包替换 state 后 quotaEnabled
//   被冲掉, "启用套餐用量" toggle 视觉上无反应 — btn-usage 一直 hidden.
// ============================================================
