// webui/test/server/router-auth-gate.check.mjs
...
// "Reached the app shell" — whichever frontend is serving. The legacy shell marks
// itself with `chat-inner`; the Next.js static export references `_next/static`.
// Both mean "the gate did not intercept", which is what these tests assert.
const isIndex = (res) =>
