...
const en = {
  ...
  "userMenu.copyUserId": "Copy user ID",
  "userMenu.upgrade": "Upgrade",
  "userMenu.manage": "Manage",
  ...
  "home.cloudUnsupported": "Not available yet",
  "toolbar.files": "Files",
  "toolbar.usage": "Usage",
  "plan.agree": "Agree",
