...
const en = {
  ...
  "providers.field.apiKeyPlaceholder": "Stored as-is — leave blank (or omit the field) to keep the existing key. Clearing is not supported.",
...
const zh: Record<MessageKey, string> = {
  ...
  "providers.field.apiKey": "API Key",
  "providers.field.apiKeyPlaceholder": "明文保存；留空或省略该字段即保持现有 Key，不支持主动清空",
